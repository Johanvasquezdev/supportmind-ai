    ...
    <div className="mx-auto max-w-3xl space-y-8">
      ...
      <section className="space-y-4">
        ...
        <div className="space-y-4 rounded-xl border border-border bg-card p-6">
          ...
          <div className="flex items-center gap-2">
            <div className="flex-1 rounded-lg border border-border bg-background px-4 py-2.5 font-mono text-sm text-foreground">
              {apiKey}
            </div>
            <button
              type="button"
              onClick={handleCopy}
              className={cn(
                "flex size-10 items-center justify-center rounded-lg border border-border transition-all hover:bg-accent",
            ...
            <button
              type="button"
              className="flex size-10 items-center justify-center rounded-lg border border-border text-muted-foreground transition-all hover:bg-accent hover:text-foreground"
